...
101-compile : a script that compiles a Python script file. *102-magic_calculation.py : Python function def magic_calculation(a, b): that does exactly the same as the given Python bytecode
